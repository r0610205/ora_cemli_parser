...
(function() {
  ...
  module.exports = {
    exportColumns: ['PRODUCT', 'OBJECT_TYPE', 'OBJECT_NAME', 'IMPACT', 'ATTRIBUTE_NAME', 'DIFFERENCE', 'COMMENT', 'SOURCE'],
    allow: {
      changes: [
        {
    ...
    impact: function(data) {
      switch (data.change) {
        case messages.objectRemoved:
          ...
          break;
        case messages.logicChange:
          data.impact = 3;
          break;
        case messages.attributeChange:
          data.impact = 4;
      }
      return data;
    },
    regex: {
      ...
      preCompile: {
        ...
        parse: function(source) {
          return {
            desc: messages.ledgerComment,
            change: messages.logicChange
          };
        }
      },
      module: {
        ...
        data: function(source) {
          ...
          source('table').each(function(index, elem) {
            ...
            return source(elem).find('tr').each(function(trIndex, tr) {
              var defaultResult, objectName, preCompileData, sourceCode, tds;
              if (trIndex === 0) {
                return;
              }
              ...
              defaultResult = function(description, comment) {
                return {
              ...
              return tds.last().find('div').each(function(divIndex, div) {
                var attrInfo, change, changeInfo, changes, listOfChanges;
